...
import { FiFilePlus, FiFileText, FiGrid, FiLogOut, FiPieChart, FiSettings, FiStar, FiUsers, FiVolume2 } from 'react-icons/fi'

const Sidebar = ({ session, isAdmin, isEmployee, isUser, isSidebarOpen, onSidebarClose }) => {
	...
	return (
		<>
			...
			<chakra.aside bg={{ base: 'system', lg: 'trasparent' }} position="fixed" top={{ base: 0, lg: 'auto' }} left={{ base: isSidebarOpen ? 0 : -256, lg: 'auto' }} h={{ base: '100vh', lg: 'calc(100vh - 72px)' }} w={256} transition="0.4s ease-in-out" zIndex={100}>
				<Grid templateRows={{ base: '72px 1fr auto', lg: '1fr auto' }} h="full">
					<GridItem display={{ base: 'grid', lg: 'none' }} alignContent="center" px={6}>
						...
						{isAdmin && (
							<>
								...
								<NextLink href="/admin/requests" passHref>
									<Link as="span" display="block" py={2} lineHeight={6} active={router.pathname.includes('requests') ? 1 : 0} onClick={onSidebarClose}>
										<Flex align="center" gap={3}>
