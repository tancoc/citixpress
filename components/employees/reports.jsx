...
import { Avatar, Badge, chakra, Divider, Flex, Icon, IconButton, Select, Td, Text, Tr, useDisclosure } from '@chakra-ui/react'
...
const Reports = ({ user }) => {
	...
	const { data: reports, isFetched: isReportsFetched } = useQuery(['employee_reports'], () => api.get('reports/employee', user._id))
